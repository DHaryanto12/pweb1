$(document).ready(function() {
    ...
    $('li:even').css('color', 'blue'); // Mengubah warna teks pada elemen <li> genap "featured").addClass('highlight'); // Menambahkan class highlight pada elemen dengan class featured
    
    // Event Handling untuk Galeri Foto
    
    $('.gallery img').on('click', function() {
    
    var src = $(this).attr('src'); $('#modallmage').attr('src', src); $('#myModal').fadeln(); });
    
    $('.modal.close').on('click', function() { $('#myModal').fadeOut(); });
